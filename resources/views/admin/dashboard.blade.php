...
<div class="row">
    ...
    <div class="col-xl-6">
        ...
        <div class="card text-white-transparent-7 mb-3 overflow-hidden">
            ...
            <div class="card-img-overlay d-none d-md-block bg-blue rounded" style="background-image: url(assets/img/bg/wave-bg.png); background-position: right bottom; background-repeat: no-repeat; background-size: 100%;">
            </div>
            ...
            <div class="card-body position-relative">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <hr class="hr-transparent bg-white-transparent-2 mt-3 mb-3" />
                        <div class="mt-3 mb-2">
                            <a href="#" class="btn btn-yellow btn-rounded btn-sm ps-5 pe-5 pt-2 pb-2 fs-14px font-weight-600"><i class="fa fa-wallet me-2 ms-n2"></i> Withdraw money</a>
                        </div>
                        <p class="fs-12px">
                ...
                <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange" style="min-height: 202px;">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div><a href="#" class="text-white d-flex align-items-center text-decoration-none">View
                                report <i class="fa fa-chevron-right ms-2 text-white-transparent-5"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-center">
                                <div class="width-50 height-50 bg-primary-transparent-2 rounded-circle d-flex align-items-center justify-content-center mb-2 ms-auto me-auto">
