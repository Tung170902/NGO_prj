...
<h1 class="page-header">
    BLOG POSTS <small>page manage blog posts</small>
</h1>
...
<div class="d-flex justify-content-between align-items-center">
    <div>
        ...
        <button onclick="window.location.href='/admin/blog/post'" type="button" class="btn btn-sm btn-success me-1">
            <i class="fa fa-cog" aria-hidden="true"></i>
        </button>
    </div>

    <div class="d-flex align-items-center">
        <form id="form-search" action="{{ route('admin.blog.post') }}" method="GET">
...
<div class="modal fade" id="modal-edit-{{$post->id}}">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.blog.post.edit',$post->id) }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    @method('PUT')
                    @csrf
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <input name="thumbnail" type='file' onchange="readURL(this);" />
                        <img style="width: 100px;" id="thumbnailEdit" src="{{$post->thumbnail}}" alt="your image" />
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-bs-dismiss="modal">Close</button>
